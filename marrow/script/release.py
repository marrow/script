...
For full documentation, see the README.textile file present in the package, or view it online on the `GitHub project page<https://github.com/pulp/marrow.script>`_."""
author = "Alice Bevan-McGregor"
email = "alice@gothcandy.com"
url = "https://github.com/pulp/marrow.script"
download_url = "https://github.com/pulp/marrow.script"
